          ...
          <div class="car"></div>
            <div class="card mb-4">
                <div class="card-header"><strong>Thêm</strong><span class="small ms-1">sản phẩm</span></div>
                    <div class="card-body">
                        <form method="post" action="addproduct"class="row g-3" enctype='multipart/form-data' style="padding:20px 20px;">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number"  data-validation="number" class="form-control" name="quantity" id="inputCity">
                            </div>
                            
                            <div class="col-md-2">
                                <label for="inputZip" class="form-label">Giá</label>
                                <input type="number" class="form-control" name="price" id="inputZip" placeholder="vnđ">
                            </div>
                            <div class="col-12">
