...
<script src="{{asset('frontend/js/Validator.js')}}"></script>
        ...
        <div class="body flex-grow-1 px-3">
                ...
                <div class="car"></div>
                    <div class="card mb-4">
                        <div class="card-header"><strong>Thêm</strong><span class="small ms-1">order</span></div>
                            <div class="card-body">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary" style="background-color: green">Thêm order</button>
                                </div>
                            </div>
